...
impl SqliteDatabase {
    ...
    /// Insert a script at the specific index and keychain
    ...
    /// Insert a serialized tx indexed by txid
    ...
    /// Update the serialized transaction stored at a txid
    ...
    pub fn insert_transaction_details(
        &self,
    ...
    /// Update the transaction details for a txid
    pub fn update_transaction_details(
        &self,
        transaction: &TransactionDetails,
    ) -> Result<(), Error> {
        let (timestamp, height) = match &transaction.confirmation_time {
    ...
    /// Insert a derivation index value for keychain
    ...
    /// Insert a checksum for the keychain
    ...
    /// Updates the last derivation index value for a keychain
    /// uses an UPSERT via INSERT ON CONFLICT DO UPDATE
    ...
    /// Get all the script pubkeys stored in the database
    ...
    /// Get all script pubkeys for a specific keychain
    pub fn select_script_pubkeys_by_keychain(
        &self,
        keychain: String,
    ...
    /// Get all script pubkeys for a specific keychain and child
    pub fn select_script_pubkey_by_path(
        &self,
        keychain: String,
        child: u32,
    ...
    /// Get the keychain and child for a specific script pubkey by raw script
    pub fn select_script_pubkey_by_script(
        &self,
        script: &[u8],
    ...
    pub fn select_utxo_by_outpoint(
        &self,
        txid: &[u8],
        vout: u32,
    ...
    /// Get all raw transactions in the database
    ...
    /// Get the raw transaction for a txid
    ...
    /// Get all transactions with details in the database
    ...
    /// Get all transaction details in the database
    ...
    /// Get the transaction details for a specific txid
    pub fn select_transaction_details_by_txid(
        &self,
        txid: &[u8],
    ...
    /// Get the last derivation index for a keychain
    pub fn select_last_derivation_index_by_keychain(
        &self,
        keychain: String,
    ...
    /// Get the checksum for a keychain
    ...
    /// Delete a script pubkey for a keychain and child index
    ...
    /// Delete a script pubkey for a specific script
    ...
    /// Delete a utxo by txid and vout
    ...
    /// Delete transaction details by txid
    ...
    /// Delete last derivation index by keychain
